<section id="div__temoignages">
  <h2>Témoignages</h2>
  <div class="temoignages__global--mobile">
    ...
    <div class="temoignages__container">
      <a class="temoignages__item" href="#">
        <figure>
          <picture>
            <source srcset="assets/img/femme1-mobile.png" media="(max-width: 770px)">
            <source srcset="assets/img/femme1-tablette.png" media="(max-width: 1024px)">
      ...
      <figure>
          <picture>
            <source srcset="assets/img/femme2-mobile.png" media="(max-width: 770px)">
            <source srcset="assets/img/femme2-tablette.png" media="(max-width: 1024px)">
      ...
      <figure>
          <picture>
            <source srcset="assets/img/femme3-mobile.png" media="(max-width: 770px)">
            <source srcset="assets/img/femme3-tablette.png" media="(max-width: 1024px)">
